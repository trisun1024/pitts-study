...
public class Q1TaskCache {

    private static String getUrl(String s) {
        if (s.contains("/assets/img/loading.gif")) return "/assets/img/loading.gif";
        return "";
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        String outputFile = "hw2/output/part3/q1res-cache";
        ...
        // Configuration
        SparkConf sparkConf = new SparkConf().setAppName("CCmini-2 Part-3 Q1");
        JavaSparkContext sc = new JavaSparkContext(sparkConf);

        // Import data
        JavaRDD<String> input = sc.textFile(inputFile).repartition(3).cache();
        ...
        sorts.repartition(1).saveAsTextFile(outputFile);
